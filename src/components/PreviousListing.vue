<template>
    ...
    <form class="ratingbox" v-on:submit.prevent v-else>
        <div class="stars">
            <input type="checkbox" name="1" id="one" class="star" @change="handleRating(1)" />
            <label for="one"></label>
            <input type="checkbox" name="2" id="two" class="star"  @change="handleRating(2)" />
            <label for="two"></label>
            <input type="checkbox" name="3" id="three" class="star"  @change="handleRating(3)" />
            <label for="three"></label>
            <input type="checkbox" name="4" id="four" class="star"  @change="handleRating(4)" />
            <label for="four"></label>
            <input type="checkbox" name="5" id="five" class="star"  @change="handleRating(5)" />
        ...
        <input type="button" value="Submit" id="submit-review" @click="makeReview()"/>
    </form>
</template>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const makeReview = ref(async () => {
            ...
            try {
                const { data } = await axios.post(`${ server_url }createreview`, {
                    customerID: user.id,
